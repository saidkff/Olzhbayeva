...
<html>
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="css/whatsapp_window.css">
...
<!--111111111111111111111111111111111111-->
      ...
      <div class="whatsapp-wrapper">
         ...
         <div class="whatsapp-popup">
            <div class="whatsapp-popup-content">
                  <span class="whatsapp-close-button" id="whatsapp-close">&times;</span>
                  <!-- Добавьте метод POST к форме -->
                  <form method="post" action="sendMessage.php">
                     <textarea id="whatsapp-message" name="message" placeholder="Введите ваше сообщение"></textarea>
                     <button id="whatsapp-send" type="submit">Отправить</button>
                  </form>
            </div>
         </div>
      </div>
      ...
      <div class="call_text_main">
         <div class="container">
            <div class="call_taital">
               <div class="call_text"><a href="#"><i class="fa fa-map-marker" aria-hidden="true"></i><span class="padding_left_15">Location: Almaty, Kazakhstan</span></a></div>
               <div class="call_text"><a href="#"><i class="fa fa-phone" aria-hidden="true"></i><span class="padding_left_15">+7 (778) 405 35-00</span></a></div>
               <div class="call_text"><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i><span class="padding_left_15">zhavokhir02@gmail.com</span></a></div>
            </div>
         </div>
      </div>
      ...
      <div class="gallery_section layout_padding" id="vehicles">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
      ...
      <div class="choose_section layout_padding" id="services">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
      ...
      <div class="client_section layout_padding" id="clients">
         <div class="container">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="client_taital_box">
                                 ...
                                 <h3 class="moark_text">Alikhan</h3>
      ...
      <div class="contact_section layout_padding" id="contact">
         ...
         <div class="container">
            <div class="contact_section_2">
               <div class="row">
                     <div class="col-md-12">
                        <form class="mail_section_1" action="insert_contact_data.php" method="post" id="contactForm">
         ...
         <script>
            function submitForm() {
               ...
               xhr.open("POST", "insert_contact_data.php", true);
               xhr.onload = function () {
                     if (xhr.status === 200) {
                        ...
                        document.getElementById("responseMessage").innerHTML = "Ошибка: " + xhr.responseText;
                     }
               };
               xhr.send(formData);
            }
            ...
            <div class="footer_section_2">
               <div class="row">
                  ...
                  <div class="col">
                     ...
                     <div class="location_text"><a href="#"><i class="fa fa-map-marker" aria-hidden="true"></i><span class="padding_left_15">Location: Almaty, Kazakhstan</span></a></div>
                     <div class="location_text"><a href="#"><i class="fa fa-phone" aria-hidden="true"></i><span class="padding_left_15">+7 (778) 405 35-00</span></a></div>
                     <div class="location_text"><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i><span class="padding_left_15">zhav@gmail.com</span></a></div>
      ...
      <div class="copyright_section">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <p class="copyright_text">2023 All Rights Reserved. Design by <a href="#">Zhavokhir Saidkulov</a></p>
               </div>
            </div>
         </div>
      </div>
      ...
      <script src="js/whatsapp_window.js"></script>
   </body>
</html>